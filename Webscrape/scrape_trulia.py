...
house_div = soup.find('div', attrs={"data-testid":"home-card-rent"})

# for places in house_div:


houses["prop_price"] = soup.find("div", attrs={"data-testid":"property-price"}).get_text()
